<template>
  <div class="boids-background overlay">
    <div ref="boidsRef" id="boids">
      ...
      >
        <div
          class="container scrollable-content text-center"
          id="scrollable_div"
        >
          ...
          <div class="row align-items-start section_wrapper">
            <div class="col-md-8">
              ...
              <p>
                ...
                Gothenburg. I am entering my third and final years of the
                bachelor curriculum and im beyond excited to further my horizons
                and prospects by hopefully uptaking a master degree in the near
                future. My time has been invaluable in this university. I met
                some truly amazing people that have taught me more than I could
                have ever hoped to learn, teachers and acquaintances alike. This
                program taught me the fundamentals of writing clean code,
                testing, various architectural styles and their applications,
                distributed systems development, web developments and so much
                more and I'm eternally grateful for the knowledge I gained.
                Finally, I was also a teacher assistant for many courses but the
                one i was most passioante about was Discrete mathematics where I
                taught students the fundamentals of graph theory, set theory,
                combinatorics and so much more.
              </p>
            </div>
            <div class="col-md-4">
              <img
          ...
          <div class="row align-items-start section_wrapper">
            <div class="col-md-6">
              ...
              <p>
                ...
                insight into the industry while I'm still in university. The
                most recent hackathon that I participated in was hosted by
                system weaver where the theme was generative AI. My team and I
                created a ChatGPT wrapper application that maps organizational
                functional requirements to user stories in the click of 2
                buttons. We finished in 3rd place but it was extremely
                insightful to see how system weaver handles client data for
          ...
          <div class="row align-items-center section_wrapper">
            <div class="col">
              ...
              <p>
                ...
                Hvitfeldtska gymnasiet where I took 6 subjects being: Math: AI
                HL, chemistry HL biology HL, English literature SL, Swedish AB
                sl and finally psychology. I graduated with a score of 39/45!
              </p>
              <img
